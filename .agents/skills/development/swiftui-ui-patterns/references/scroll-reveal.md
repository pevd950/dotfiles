...
Use the nearest in-repo detail surface or media viewer as the concrete reference when applying this pattern. Keep copied examples generic in tracked dotfiles so the skill remains portable across hosts.
